...
import { GlobeAltIcon, MenuIcon, SearchIcon, UserCircleIcon, GlobeIcon, UserIcon } from '@heroicons/react/solid'
  ...
  return (
    <header className='sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md p-5 md:px-10'>
      ...
      <div className='flex items-center md:border-2 rounded-full py-2 md:shadow-lg'>
        <input className=" flex-grow pl-5 bg-transparent outline-none text-sm text-gray-600 placeholder-gray-400" type='text' placeholder={placeholder ? placeholder : "Start your search"} value={searchInput} onChange={(e) => setSearchInput(e.target.value)} />
      ...
      <div className='flex items-center space-x-4 justify-end text-gray-500'>
        ...
        <div className="flex items-center space-x-2 border-2 p-2 rounded-full">
          ...
          <UserCircleIcon className="h-6" onClick={() => userProfileHandler()} />
        </div>
      </div>
